...
var p_set = {
        'android': {
            ...
            'dl_link_url': 'https://cdn.jsdelivr.net/gh/kkdysite/app.kkdy.website/ClientApp/kkdy.Phone.2.2.apk',
        ...
        'windows': {
            ...
            'html': "备用下载地址：<a href='https://cdn.jsdelivr.net/gh/kkdysite/app.kkdy.website/ClientApp/kkdy.site.Win32.exe' target='_bank' external>jsdelivr直连</a> <br>部分电脑可能会提示检查风险，请点其他 允许运行即可。 <br> 注意：基于win10开发，兼容win7（需要用兼容性模式运行) "
        },
        'mac': {
            'name': 'mac电脑','button_name': "下载mac版本",'dl_link_name': '下载 看看电影.app',
            'dl_link_url': 'https://kkdy.lanzous.com/b00trik8d',
            'html': "备用下载地址：<a href='https://cdn.jsdelivr.net/gh/kkdysite/app.kkdy.website/ClientApp/kkdy.site.MacApp.zip' target='_bank' external>jsdelivr直连</a> <br>mac版下载后解压，打开访达，拖动到应用程序里面。首次运行可能会提示安全风险，在系统偏好设置 安全与隐私 打开。以后打开不会再继续提示。<br>仅支持macos10.12 以后的系统。更低版本请使用免安装版"
        },
        'ios': {
